      ...
      <ul class="timeline">
        <li>
          <div class="direction-r">
            <div class="flag-wrapper">
              <span class="flag">
                <a
                  href="https://github.com/Siddesh7/canto-index-app"
                  target={"_blank"}
                  rel="noreferrer"
                >
                  Building Canto Index
                </a>
              </span>
            ...
            <div class="desc">
              Canto Index is an asset management protocol on Canto Network.
            </div>
          </div>
        </li>
          ...
          <div class="direction-l">
            <div class="flag-wrapper">
              <span class="flag">
                {" "}
                <a
                  href="https://d-hire.vercel.app/"
                  target={"_blank"}
                  rel="noreferrer"
                >
                  dHire - Next Video Buidl
                </a>
              </span>
              <span class="time-wrapper">
                <span class="time">2023-Jan</span>
              </span>
            </div>
            <div class="desc">
              Built an dapp for hiring management and won 3 bounties from
              Filecoin, Push Protocol, ENS.
            </div>
          </div>
        </li>
        <li>
          <div class="direction-r">
            <div class="flag-wrapper">
              <span class="flag">
                {" "}
                <a
                  href="https://github.com/Siddesh7/ebook-market"
                  target={"_blank"}
                  rel="noreferrer"
                >
                  DeBook - Chainlink Fall 2022
                </a>
              </span>
              <span class="time-wrapper">
                <span class="time">2022-Nov</span>
              </span>
            </div>
            <div class="desc">
              Built an dapp to let users create eBooks on Filecoin and won
              Filecoin bounty.
            </div>
          </div>
        </li>
        <li>
          <div class="direction-l">
            ...
            <div class="desc">
              Built a UI for splitting bills on EVM chains and won bounty for
              best use of Covalent API.
            </div>
          </div>
        </li>
